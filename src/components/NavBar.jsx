  ...
  return (
    <nav className="nav">
      ...
      <div className="navRight">
        ...
        <a href="https://github.com/arukudassova" target="_blank" rel="noopener noreferrer" className="navIcon" aria-label="GitHub">
        ...
        <a href="mailto:arukudass@gmail.com" className="navIcon" aria-label="Email">
